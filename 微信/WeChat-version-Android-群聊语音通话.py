"""
@File    :   WeChat-version-Android-HUAWEI-群聊语音通话.py
@APPTYPE :   Android

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/9 19:16    xyhu       8.0.20      621
"""
import time
...
def group_audio_call():
    ...
    # time.sleep(2)
    a_el4 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="语音通话"]')
    a_el4.click()
    time.sleep(2)
    a_el5 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="A测试"]')#选择的昵称
    a_el5.click()
    time.sleep(2)
    a_el6 = a_driver.find_element(By.ID, 'com.tencent.mm:id/em')
    a_el6.click()
    time.sleep(5)
    b_el3 = b_driver.find_element(By.XPATH,'//android.widget.ImageButton[@content-desc="接听"]')
    b_el3.click()
    time.sleep(6)
    a_el7 = a_driver.find_element(By.XPATH, '//android.widget.ImageButton[@content-desc="挂断"]')
    a_el7.click()
    time.sleep(2)
