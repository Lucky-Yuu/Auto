"""
@File    :   WeChat-version-Android-HUAWEI-群聊收视频.py
@APPTYPE :   Android

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/9 17:01    xyhu       8.0.20      774
"""
import time
...
def group_recv_video():
    ...
    a_el3.click()
    time.sleep(2)
    a_el4 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="拍摄"]')
    a_el4.click()
    time.sleep(2)
    a_driver.tap([(513 / 1224 * a_width, 2355 / 2601 * a_height), (709 / 1224 * a_width, 2551 / 2601 * a_height)], 4000)
    time.sleep(2)
    a_el6 = a_driver.find_element(By.XPATH, '//android.widget.Button[@text="完成"]')
    a_el6.click()
    time.sleep(3)
