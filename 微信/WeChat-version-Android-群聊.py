"""
@File    :   WeChat-version-Android-HUAWEI-群聊.py
@APPTYPE :   Android11

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/9 10:10    xyhu       8.0.19      13
"""
import time
...
def group_send_msg():
    ...
    el3.send_keys("测试test1234")
    el4 = driver.find_element(By.XPATH, '//android.widget.Button[@text="发送"]')
    el4.click()
    time.sleep(2)
