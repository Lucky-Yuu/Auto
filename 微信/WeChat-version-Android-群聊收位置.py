"""
@File    :   WeChat-version-Android-HUAWEI-群聊收位置.py
@APPTYPE :   Android

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/9 16:49    xyhu       8.0.20      470
"""
import time
...
def group_recv_location():
    ...
    a_el3.click()
    time.sleep(2)
    a_el4 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="位置"]')
    a_el4.click()
    time.sleep(2)
    a_el5 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="发送位置"]')
    a_el5.click()
    time.sleep(3)
    a_el6 = a_driver.find_element(By.XPATH, '//android.widget.TextView[@text="发送"]')
    a_el6.click()
    time.sleep(3)
