'''
@File    :   抖音-version-Android-群聊发红包.py    
@APPTYPE :   Android
@Model   :   Huawei P50

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/29 15:21   xyhu       20.0.0      None
'''
import time
...
def group_send_red_env():
    ...
    el6.click()
    time.sleep(2)
    el7 = driver.find_element(By.XPATH, '//android.widget.RelativeLayout[1]/android.widget.EditText')
    el7.send_keys("0.01")
    el8 = driver.find_element(By.XPATH, '//android.widget.RelativeLayout[2]/android.widget.EditText')
    el8.send_keys("1")
    el9 = driver.find_element(By.XPATH, '//android.widget.EditText[@text="大吉大利"]')
    el9.send_keys("测试test1234")
    el10 = driver.find_element(By.XPATH, '//android.widget.TextView[@text="发红包"]')
    el10.click()
    time.sleep(2)
    el11 = driver.find_element(By.XPATH, '//android.widget.TextView[contains(@text,"抖音零钱")]')
    el11.click()
    time.sleep(2)
    el12 = driver.find_element(By.XPATH, '//android.widget.TextView[@text="确认支付"]')
    el12.click()
    time.sleep(2)
    for i in Devices.douyin_account['pay_password']:
        el13 = driver.find_element(By.XPATH, '//android.widget.TextView[@text="' + i + '"]')
        el13.click()
        time.sleep(1)
    time.sleep(5)
