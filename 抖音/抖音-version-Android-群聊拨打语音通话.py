'''
@File    :   抖音-version-Android-群聊拨打语音通话.py    
@APPTYPE :   Android
@Model   :   Huawei P50
...
def group_call_voice():
    ...
    el6.click()
    time.sleep(3)
    el7 = driver.find_element(By.XPATH,'//android.widget.TextView[@text="A测试"]')
    el7.click()
    time.sleep(2)
    el8 = driver.find_element(By.XPATH, '//android.widget.TextView[contains(@text,"邀请")]')
    el8.click()
    time.sleep(5)
