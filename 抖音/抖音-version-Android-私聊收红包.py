'''
@File    :   抖音-version-Android-私聊收红包.py    
@APPTYPE :   Android
@Model   :   Huawei P50

@Modify Time      @Author    @Version    @Action
------------      -------    --------    -----------
2022/3/30 10:20   xyhu       20.0.0      None
'''
import time
...
def rec_red_env():
    ...
    b_el6.click()
    time.sleep(2)
    b_el7 = b_driver.find_element(By.ID, 'com.ss.android.ugc.aweme:id/edit_text')
    b_el7.send_keys("0.01")
    b_el8 = b_driver.find_element(By.XPATH, '//android.widget.EditText[@text="大吉大利"]')
    b_el8.send_keys("测试test1234")
    b_el9 = b_driver.find_element(By.XPATH, '//android.widget.TextView[@text="发红包"]')
    b_el9.click()
    time.sleep(2)
    b_el10 = b_driver.find_element(By.XPATH, '//android.widget.TextView[contains(@text,"抖音零钱")]')
    b_el10.click()
    time.sleep(2)
    b_el11 = b_driver.find_element(By.XPATH, '//android.widget.TextView[@text="确认支付"]')
    b_el11.click()
    time.sleep(2)
    for i in Devices.douyin_account['pay_password']:
        b_el12 = b_driver.find_element(By.XPATH, '//android.widget.TextView[@text="' + i + '"]')
        b_el12.click()
        time.sleep(1)
    time.sleep(3)
